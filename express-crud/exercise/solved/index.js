...
/*
  GET REQUEST to send looney tunes's info from the server side to the client side
  Using express, the syntax for a "get" is using "app.get", like below
*/
app.get('/looney-tunes-characters', function(req, res){
  // sending looney tunes's info to the client
...
app.get('/looney-tunes-characters/:character', function(req, res){
  ...
  let response;
  if(characterExists){
    // sending looney tunes character's info to the client
